...
## Solución
- ##### Al entrar al sitio web, nos da un script para desencriptar la bandera, por lo que inspeccionamos el código fuente y nos metemos a la consola.
```html
<!doctype html>
<html lang="en">
...
- ##### Al poner el script que nos da el sitio en la consola, obtenemos la bandera.
```
