...
## Solución
```
┌──(kali㉿kali)-[~/picoCTF/Reversing/keygenme-py]
└─$ wget https://mercury.picoctf.net/static/fb75b48f9214cf992a2199b5785564e7/keygenme-trial.py
--2024-11-21 23:39:41--  https://mercury.picoctf.net/static/fb75b48f9214cf992a2199b5785564e7/keygenme-trial.py
...
2024-11-21 23:39:41 (322 MB/s) - ‘keygenme-trial.py’ saved [10198/10198]
...
>>> hashed[4] + hashed[5] + hashed[3] + hashed[6] + hashed[2] + hashed[7] + hashed[1] + hashed[8]
'0d208392'
>>> exit()
```

- ##### Después de desencriptar la parte restante de la bandera mediante el username "FREEMAN", obtenemos la bandera.
```
